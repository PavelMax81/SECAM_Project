...
public class Xform extends Group{
    ...
    public javafx.scene.transform.Scale s = new javafx.scene.transform.Scale();
    ...
    /**
    @reset() method
    * set all the Xform parameters to 0.0 and the scale parameters to 1.0
    */
    public void reset() {
        t.setX(0.0);
        t.setY(0.0);
    ...
    /**
    @resetTSP method
    * set all Xform parameters to 0.0 except the Rotation parameters
    */
